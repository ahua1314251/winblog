...
import org.winker.winweb.winblog.common.Constant;
import org.winker.winweb.winblog.dao.mysql.entity.TableInfoDO;
import org.winker.winweb.winblog.dao.mysql.entity.TableInfoQuery;
import org.winker.winweb.winblog.dao.mysql.entity.TemplateDO;
import org.winker.winweb.winblog.dao.mysql.entity.TemplateQuery;
import org.winker.winweb.winblog.dao.mysql.mapper.TableInfoMapper;
import org.winker.winweb.winblog.dao.mysql.mapper.TemplateMapper;
import org.winker.winweb.winblog.utils.database.MysqlParserUtils;
import org.winker.winweb.winblog.web.bean.Table;
import org.winker.winweb.winblog.web.bean.TemplateEntity;
...
//                System.out.println(tableSet.getString("TABLE_NAME"));
    ...
    public List<TemplateEntity>  createCode(Long sqlId, List<String> templateNames){
        ...
        org.winker.winweb.winblog.utils.database.Table table = MysqlParserUtils.getTable(sql);
